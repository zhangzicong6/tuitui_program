$(function(){
	...
	text[0]='<span class="noselect">你的自测分析结果,已发送给专业淡斑顾问，这是老师的微信微信号</span><span style="background:yellow;color:red;" class="statistics02" oncopy="copy()">'+stxlwx+'</span><span class="noselect">，复制添加老师，获取属于你的淡斑方案吧！</span> ';
	text[1]='您的手机号码我们已收到，稍后我们的老师会电话通知您自测分析检测结果；或直接添加专家微信：<span style="color:red;"></span>，随时咨询专家！';
	btnarr[0]='<div class="wdfixbom noselect" id="wdfixbom"><div class="btnbox w100 bhf-container"><button class="btn noselect" index="1" wtindex="0">咨询</button><div style="font-size: 0.9rem;text-align: center;">版权所有 '+copyright+'</div></div></div>';
	...
	btnarr[9]+='</ul>';
	warr[0]='<p class="noselect">您好，我是专业淡斑护肤老师兰馨，你现在已获得一对一服务！请问你是什么斑点呢？</p>';
